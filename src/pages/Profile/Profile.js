...
import {Form, Field, FormRow, Select, Option, ErrorMessage, Label} from "../../lib/style/generalStyles";
...
const Profile = () => {
    ...
    <Section title={"My Profile"} isMainSection isCentered>
                    ...
                    <Form isCentered>
                        ...
                        <FormRow>
                            <Button isOutline isForm disabled={formik.isSubmiting}>
                                   {formik.isSubmitting ? "Processing..." : "Profile"}
                            </Button>
                        </FormRow>
                    </Form>
                )}
